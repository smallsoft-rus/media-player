...
#define PROGRAM_VERSION L"v2.6"
#define SMPVER_MAJOR 2
#define SMPVER_MINOR 6
...
typedef enum {VIDEOTYPE_VIDEO=0,VIDEOTYPE_MPEG1=1,VIDEOTYPE_MPEG2=2,VIDEOTYPE_H264ES=3} SMP_VIDEOTYPE;
...
// PCM big-endian
#define AUDIO_PCM_BE (0x6e69)
// MEDIASUBTYPE_PCM_IN24 (signed big-endian int24): 34326E69-0000-0010-8000-00AA00389B71
